...
import static me.iwf.photopicker.utils.MediaStoreHelper.INDEX_ALL;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ImageCaptureManager.REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            if (directories.size() > 0) {
                ...
                PhotoDirectory directory = directories.get(INDEX_ALL);
                directory.getPhotos().add(INDEX_ALL, new Photo(path.hashCode(), path));
