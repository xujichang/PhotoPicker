...
public class MainActivity extends AppCompatActivity {
    ...
    enum RequestCode {
        ...
        ButtonVideoSelect(R.id.button_video_picked);
        @IdRes
        final int mViewId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_video_picked).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                VideoPicker.builder().start(MainActivity.this);
            }
        });
