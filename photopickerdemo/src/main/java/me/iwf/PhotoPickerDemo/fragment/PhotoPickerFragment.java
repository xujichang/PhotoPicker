...
import me.iwf.PhotoPickerDemo.PhotoPickerActivity;
import me.iwf.PhotoPickerDemo.R;
import me.iwf.PhotoPickerDemo.adapter.PhotoGridAdapter;
...
import me.iwf.PhotoPickerDemo.utils.ImageCaptureManager;
...
public class PhotoPickerFragment extends Fragment {
     ...
     * 构造方法 拼装参数
     *
     * @param showCamera     是否显示拍照的图标
     * @param showGif        是否显示Ｇif
     * @param previewEnable  是否可以预览
     * @param column         列数
     * @param maxCount
     * @param originalPhotos
     * @return
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //初始化 文件目录选择的ListView 所使用的Adapter
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ImageCaptureManager.REQUEST_TAKE_PHOTO && resultCode == Activity.RESULT_OK) {
            ...
            if (directories.size() > 0) {
                ...
                PhotoDirectory directory = directories.get(MediaStoreHelper.INDEX_ALL);
                directory.getPhotos().add(MediaStoreHelper.INDEX_ALL, new Photo(path.hashCode(), path));
